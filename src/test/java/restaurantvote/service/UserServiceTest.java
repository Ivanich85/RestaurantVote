...
public class UserServiceTest extends AbstractServiceTest {
    ...
    public void duplicateMailCreate() throws Exception {
        assertThrows(DataIntegrityViolationException.class, () -> service.create(new User(null, "Duplicate", "admin@gmail.com", "newPass", false,
                LocalDateTime.now(), Collections.singleton(Role.ROLE_USER), userVotes)));
    }
    ...
    public void getByNotExistEmail() throws Exception {
        assertThrows(NotFoundException.class, () -> service.getByEmail("user@mail.ru"));
    }
    ...
    public void voteSecondTimeDenied() throws Exception {
        assertThrows(SecondVoteDeniedException.class, () -> service.vote(USER, MC_REST, SECOND_VOTE_TIME_AFTER_LIMIT));
    }
}